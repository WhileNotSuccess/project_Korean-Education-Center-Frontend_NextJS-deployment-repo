...
export const RegisterCompoMenu: Record<Language, Record<string, string>> = {
  ...
  [Language.english]: {
    ...
    requireAll: "Please fill in all required fields.",
    passwordMismatch: "Passwords do not match.",
    invalidDate: "Birth date must be YYYY-MM-DD.",
    back: "Back",
    pageTitle: "Korean Education Center Registration",
    lastName: "Last Name",
  ...
  [Language.japanese]: {
    ...
    nameChange: "名前変更",
    registerComplete: "会員登録が完了しました！",
    registerError: "登録できません。",
    nameChangeComplete: "名前が正常に変更されました。",
    nameChangeError: "名前を変更できません。",
    requireAll: "すべての必須項目を入力してください。",
    passwordMismatch: "パスワードが一致しません。",
    invalidDate: "生年月日は YYYY-MM-DD 形式で入力してください。",
    back: "戻る",
    pageTitle: "韓国語教郁育センター会員登録",
    lastName: "姓 (Last Name)",
    firstName: "名 (First Name)",
    lastNamePlaceholder: "ホン",
    firstNamePlaceholder: "ギルドン",
    birthDate: "生年月日 (Birth Date)",
    email: "メール (Email)",
    phoneNumber: "電話番号 (Phone Number)",
    password: "パスワード (Password)",
    confirmPassword: "パスワード確認 (Confirm)",
